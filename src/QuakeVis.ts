...
export class QuakeVis extends gfx.GfxApp
{
    ...
    {
        if(event.buttons > 0 && this.earth.globeMode)
        {
            ...
            this.earth.rotateX(event.movementY*0.04);
    ...
    onMouseWheel(event: WheelEvent): void 
    {
        ...
        // to complete the base assignment.
        if(event.deltaX > 0){
            this.earth.scale.multiplyScalar(0.99);
        }
        else if (event.deltaX < 0){
            this.earth.scale.multiplyScalar(1.01);
        }
